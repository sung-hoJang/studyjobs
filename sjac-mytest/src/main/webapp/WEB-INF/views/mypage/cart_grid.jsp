...
<div class="list-results">
                                <div class="row" id="grouplist">
                                    ...
                                    <div class="col-md-4" style="cursor:pointer" onclick="popup('${cartList.memberVO.id}')">
                                      <div class="item-ads-grid">
                                      
                                            <div class="item-img-grid">
                                                 <img alt="" src="${cartList.subjectVO.categoryImg}" class="img-responsive img-center">
                                            </div>
                        ...
                        <ul>
                           ...
                           <li class="item-cat"> ${cartList.subjectVO.subjectCategory} ,${cartList.subjectVO.subject}</li>
                        </ul>

                        <ul>
                           <li class="item-location"><a href="category.html"><i
                                 class="fa fa-map-marker"></i> 지역</a></li>
                           <li class="item-location"><a href="category.html">${cartList.gLocation }</a></li>
                        </ul>

                        <ul>
                           <li class="item-date"><i class="fa fa-user"></i> 인원</li>
                           <li class="item-date">${cartList.curMember}/${cartList.gCount }</li>
                        </ul>
                        
                        <ul>
							<li><i class="fa fa-clock-o"> 그룹 시작</i></li>
							<li>${cartList.gDate}</li>
						</ul>


                        <ul>
                           <li class="item-type"><i class="fa fa-comment-o"></i> 소개</li><br>
                           <li class="item-type" style="width:230px;height:40px;text-overflow: ellipsis;-o-text-overflow:ellipsis;overflow: hidden;    white-space: nowrap;word-wrap: normal !important;cursor:hand">${cartList.gInfo }</li>
                        </ul>
                     </div>
                                            ...
                                            <div class="product-footer">
                                                <div class="item-price-grid pull-left">
                                                    <h3>그룹장 : ${cartList.memberVO.id}</h3>
                                                </div>
                                            </div>
