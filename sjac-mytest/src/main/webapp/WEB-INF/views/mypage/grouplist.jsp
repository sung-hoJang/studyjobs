...
<div class="list-results">
                                <div class="row" id ="grouplist" >
                                  <c:forEach items="${requestScope.map.myGroupList}" var="groupList">
                                    ...
                                    <div class="col-sm-2 col-xs-3">
                                                ...
                                                <div class="col-sm-8 col-xs-6">
                                                    ...
                                                    <div class="item-meta">
                                                        <ul>
                                                            <li class="item-date" style="width:230px;height:40px;text-overflow: ellipsis;-o-text-overflow:ellipsis;overflow: hidden;    white-space: nowrap;word-wrap: normal !important;cursor:hand"><i class="fa fa-comment-o"></i> ${groupList.gInfo }</li>
                                                        </ul>
                                                        <ul>
                                                            ...
                                                            <li class="item-type"><i class="fa fa-user"></i> ${groupList.curMember}/${groupList.gCount }</li>
                                                        </ul>
                                                        <ul>
                                                            <li ><i class="fa fa-clock-o"> 그룹 시작 : ${groupList.gDate}</i></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                <!-- 그룹정보 끝 -->
