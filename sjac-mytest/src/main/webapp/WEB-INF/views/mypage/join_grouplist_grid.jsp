...
<div class="list-results">
                        ...
                        <ul>
                           ...
                           <li class="item-date">${joinList.curMember}/${joinList.gCount }</li>
                        </ul>
                        
                         <ul>
                     <li><i class="fa fa-clock-o"> 그룹 시작</i></li>
                     <li>${joinList.gDate}</li>
                  </ul>


                        <ul>
                           <li class="item-type"><i class="fa fa-comment-o"></i> 소개</li><br>
                           <li class="item-type" style="width:230px;height:40px;text-overflow: ellipsis;-o-text-overflow:ellipsis;overflow: hidden;    white-space: nowrap;word-wrap: normal !important;cursor:hand"> ${joinList.gInfo }</li>
                        </ul>
                     </div>
