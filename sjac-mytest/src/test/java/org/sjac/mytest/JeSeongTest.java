...
import org.sjac.model.ScheduleDAO;
...
public class JeSeongTest {
	...
	@Test
	public void test(){
		transactionService.deleteGroupTransaction("ng");
		/*transactionService.deleteMemberTransaction("ng");*/
		/*transactionService.TransactionAll(gvo, gmvo);*/
		System.out.println("트랜젝션 성공 공공공공공공공공공공공공공공공공공공공");
	}
}
